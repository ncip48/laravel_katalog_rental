...
<head>
    ...
    <!-- title  -->
    <title>Sistem Reservasi Gedung Aula</title>
    ...
    <div class="main-wrapper">
            ...
            <div class="container">
                ...
                <form method="post" action="#!">
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-md-3 margin-15px-top">
                            <button type="submit" class="butn no-margin-bottom">Check Availability</button>
                        </div>
                    </div>
                </form>
        ...
        <section>
            <div class="container">
                ...
                <div class="owl-carousel owl-theme text-center" id="testmonials-carousel">
                    <div>
                        <img class="rounded-circle margin-30px-bottom" src="img/testmonials/t-1.jpg"
                            alt="" />
                        <p
                    ...
                    <div>
                        <img class="rounded-circle margin-30px-bottom" src="img/testmonials/t-2.jpg"
                            alt="" />
                        <p
                            class="line-height-35 xs-line-height-30 font-size18 xs-font-size16 text-extra-dark-gray margin-30px-bottom xs-margin-25px-bottom width-60 md-width-65 sm-width-85 xs-width-100 center-col font-italic">
                            "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                    ...
                    <div>
                        <img class="rounded-circle margin-30px-bottom" src="img/testmonials/t-3.jpg"
                            alt="" />
                        <p
                            class="line-height-35 xs-line-height-30 font-size18 xs-font-size16 text-extra-dark-gray margin-30px-bottom xs-margin-25px-bottom width-60 md-width-65 sm-width-85 xs-width-100 center-col font-italic">
                            "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
        ...
        <section class="no-padding">
            <div class="container-fluid no-padding">
                <div class="row no-gutters">
                    <div class="col-lg-6">
                        <div class="padding-ten-tb bg-img" data-overlay-dark="5"
                            data-background="img/content/04.jpg">
                    ...
                    <div class="col-lg-6">
                        <div class="padding-ten-tb bg-img" data-overlay-dark="5"
                            data-background="img/content/05.jpg">
                            <div class="position-relative z-index-1 text-center extra-1">
