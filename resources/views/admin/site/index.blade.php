                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <form method="post" action="{{ route('admin.website.update', $site) }}"
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" class="form-control" id="whatsapp"
                                                    name="whatsapp" value="{{ $site->whatsapp }}">
                                                @error('whatsapp')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="haribuka" name="haribuka"
                                                value="{{ $site->haribuka }}">
                                            @error('haribuka')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                ...
                                <div class="card-footer float-end">
                                    <div>
                                        <button type="submit" class="btn btn-icon icon-left btn-ungu">Ubah
                                            Pengaturan</button>
                                    </div>
                                </div>
                            </form>
