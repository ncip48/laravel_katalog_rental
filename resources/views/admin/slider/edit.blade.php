...
@section('content')
    ...
    <section class="section">
        <div class="section-body">
            <h4 class="section-title">Edit Slider</h4>
            <div class="row">
                <div class="col-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea type="text" class="form-control" id="description" name="description" required>{{ old('title', $slider->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
