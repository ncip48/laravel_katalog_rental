                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8 col-md-4 ms-auto">
                                        <form id="search" method="GET"
                                            action="{{ route('karyawan.reservasi.index') }}">
                                                    ...
                                                    <td class="text-end">
                                                        <div class="d-flex justify-content-end">
                                                            ...
                                                            @if ($reservasi->status == 2)
                                                                <form class="me-2"
                                                                    action="{{ route('karyawan.reservasi.proses', $reservasi->id) }}"
                                                                    method="POST">
                                                                    <input type="hidden" name="_method" value="POST">
                                                                    <input type="hidden" name="_token"
                                                                        value="{{ csrf_token() }}">
                                                                    <button class="btn btn-sm btn-info btn-icon "
                                                                        type="submit"><i class="fa fa-check"></i> Proses
                                                                    </button>
                                                                </form>
                                                                ...
                                                                <form class="me-2"
                                                                    ...
                                                                    <button class="btn btn-sm btn-primary btn-icon "
                                                                        type="submit"> Upload ulang </button>
                                                                </form>
                                                            @endif
                                                            <form
                                                                action="{{ route('karyawan.reservasi.destroy', $reservasi->id) }}"
                                                                method="POST">
